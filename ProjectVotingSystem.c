...
{ 
    ...
    if(pin==0)
    {
        ...
        int in_cntrl=1;
            ...
            do
            {
                ...
                printf("\n");
                printf("\n");
                printf("                                     [The system has a security pin set!!]                                                ");
                printf("\n");
                printf("\n");}
                printf("\n************************************************************************************************************************");
                printf("\n"); 
    ...
    else
    {
        ...
        { 
            ...
            if(in_cntrl==3){elec_mon_yr();}
            else if(in_cntrl==0){first_screen();}
            else if (in_cntrl==1){reset_pin();}
            else if(in_cntrl==4){to_add_can();}
            else if(in_cntrl==2){voter_details();}
            else{results();}
